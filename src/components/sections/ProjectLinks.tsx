...
const ALL_PROJECTS: ProjectLink[] = [
  {
    name: 'PaLeva — Restaurant Management System',
    repoUrl: 'https://github.com/laisrod/PaLeva',
    demoUrl: 'https://pa-leva.vercel.app/login',
  },
  {
    name: 'Brazilian Cinema — Movie Discovery',
    ...
    >
      <div className="project-links__list">
        {ALL_PROJECTS.map((project) => (
          <div key={project.name} className="project-links__item">
            <span className="project-links__name">{project.name}</span>
            <div className="project-links__actions">
              <Button
                ...
                ariaLabel={`Demo of ${project.name}`}
              >
                <svg
                  width="14"
                  height="14"
              ...
              <Button
                ...
                target="_blank"
                rel="noopener noreferrer"
                ariaLabel={`Repository of ${project.name}`}
              >
                <svg
                  width="14"
                  height="14"
